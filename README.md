...
| `WithMemberNamingConvention` | Function that returns the name of a field or property. Multiple conventions can be added when the predicate is specified. |
| `WithFieldNamingConvention` | Function that returns the name of a field. Multiple conventions can be added when the predicate is specified. |
| `WithPropertyNamingConvention` | Function that returns the name of a property. Multiple conventions can be added when the predicate is specified. |
| `WithArrayItemNamingConvention` | Function that returns the name of an array item. Multiple conventions can be added when the predicate is specified. |
| `WithTypeNamingConvention` | Function that returns the name of a type. Multiple conventions can be added when the predicate is specified. |
| `WithNamingConvention` | Function that returns the name of fields, properties, array items and types. Multiple conventions can be added when the predicate is specified. |
